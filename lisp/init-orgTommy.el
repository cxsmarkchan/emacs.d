...
(setq org-agenda-scheduled-leaders '("已安排:" "计划已过期 %2d 天:"))
...
(setq org-agenda-sorting-strategy
      (quote ((agenda time-up habit-up priority-down deadline-up category-keep)
