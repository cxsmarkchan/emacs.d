...
(defcustom org-directory (concat default-dir "/org")
...
(setq org-capture-templates
      (quote (("t" "Todo" entry (file (concat org-directory "/Refile.org"))
              ...
              ; ("r" "respond" entry (file "~/materials/org/Refile.org")
              ;  "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
              ; ("n" "note" entry (file "~/git/org/Refile.org")
              ;  "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+datetree (concat org-directory "/Diary.org"))
               "* %?\n%T\n" :clock-in t :clock-resume t)
              ("d" "Diary" entry (file+datetree+prompt (concat org-directory "/Diary.org"))
               "* %?\n%T\n" :clock-in t :clock-resume t)
